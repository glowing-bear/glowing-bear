...
build-electron-windows: uselocal
	electron-packager ${ELECTRON_COMMON} --platform=win32 --arch=ia32 --version=0.37.6 --icon=assets/img/favicon.ico --asar=true

build-electron-darwin: uselocal
	electron-packager ${ELECTRON_COMMON} --platform=darwin --arch=x64 --version=0.37.6 --icon=assets/img/glowing-bear.icns

build-electron-linux: uselocal
	electron-packager ${ELECTRON_COMMON} --platform=linux --arch=x64 --version=0.37.6 --icon=assets/img/favicon.ico
